...
import {receiveDay, receiveSwim, receiveBusiness, receiveInternational, receiveCold, receiveMoney} from '../../actions/needsActions';
...
const mdp = dispatch => ({
    ...
    receiveMoney: ele => dispatch(receiveMoney(ele)),
});
